...
exports.getSymbolPrice = async (products) => {
  ...
  if (symbols?.length) {
    var req = new MT5Request(
      process.env.MT5_SERVER_IP,
      process.env.MT5_SERVER_PORT,
    )
    return new Promise((resolve, reject) => {
      req.Auth(
        process.env.MT5_MANAGER_USER,
        process.env.MT5_MANAGER_PASS,
        process.env.MT5_MANAGER_USER_CODE,
        process.env.MT5_MANAGER_USER_TYPE,
        function (error) {
          if (error) {
            // console.log(error);
            return
          }
          req.Get('/api/tick/last?symbol=' + symbols, function (
            error,
            res,
            body,
          ) {
...
//   var req = new MT5Request(process.env.MT5_SERVER_IP, process.env.MT5_SERVER_PORT);
//   return new Promise((resolve, reject) => {
//     req.Auth(process.env.MT5_MANAGER_USER, process.env.MT5_MANAGER_PASS,process.env.MT5_MANAGER_USER_CODE, process.env.MT5_MANAGER_USER_TYPE, symbol, function (error) {
//       if (error) {
//         console.log(error);
//         return;
//       }
  ...
  return new Promise((resolve, reject) => {
    req.Auth(
      ...
      function (error) {
        ...
        let group =process.env.MT5_MANAGER_GROUP;
  ...
  return new Promise((resolve, reject) => {
    req.Auth(
      ...
      function (error) {
        ...
        req.Post('/api/dealer/send_request', rawBody, function (
          error,
          res,
          body,
        ) {
    ...
    return new Promise((resolve, reject) => {
      req.Auth(
        ...
        function (error) {
          ...
          let rawBody = JSON.stringify({
            SourceLogin: process.env.MT5_MANAGER_USER,
            Action: 200,
            Login: account,
            Symbol: symbol,
            Volume: quantity + '0000',
    ...
    return new Promise((resolve, reject) => {
      req.Auth(
        ...
        function (error) {
          ...
          req.Get('/api/position/get_page?login=' + account, function (
            error,
            res,
            body,
          ) {
...
exports.getSymbolDetails = async (symbol) => {
  if (symbol) {
    ...
    // var req = new MT5Request("secmt5.afkkarr.com", process.env.MT5_SERVER_PORT);
    return new Promise((resolve, reject) => {
      req.Auth(
        process.env.MT5_MANAGER_USER,
        process.env.MT5_MANAGER_PASS,
        ...
        function (error) {
          ...
          req.Get('/api/symbol/get?symbol=' + symbol, function (
            error,
            res,
            body,
          ) {
    ...
    return new Promise((resolve, reject) => {
      req.Auth(
        ...
        function (error) {
          ...
          req.Get('/api/user/get?login=' + account, function (
            error,
            res,
            body,
          ) {
